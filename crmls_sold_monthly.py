...
if token:
    ...
    for month in range(1, 13):
        ...
        end_date = datetime(2026, month + 1, 1) if month < 12 else datetime(2027, 1, 1)
        url = 'https://api-trestle.corelogic.com/trestle/odata/Property'
        ...
        params = {
            ...
            '$filter': f"MlsStatus eq 'Closed' and CloseDate ge {start_date.isoformat(timespec='milliseconds')}Z and CloseDate lt {end_date.isoformat(timespec='milliseconds')}Z",
        ...
        total_records = 0
        csv_file = f'CRMLSSold2026{month:02d}.csv'
